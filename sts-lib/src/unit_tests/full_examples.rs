...
fn pi_1e6() {
    let expected: HashMap<Test, Vec<(usize, f64)>> = [
        ...
        (Test::BinaryMatrixRank, vec![(0, 0.083553)]),
...
fn e_1e6() {
    let expected: HashMap<Test, Vec<(usize, f64)>> = [
        ...
        (Test::BinaryMatrixRank, vec![(0, 0.306156)]),
...
fn sha1_1e6() {
    let expected = [
        ...
        (Test::BinaryMatrixRank, vec![(0, 0.577829)]),
...
fn sqrt2_1e6() {
    let expected = [
        ...
        (Test::BinaryMatrixRank, vec![(0, 0.823810)]),
...
fn sqrt3_1e6() {
    let expected = [
        ...
        (Test::BinaryMatrixRank, vec![(0, 0.314498)]),
