...
impl TemplateArg<'static> {
    ...
    fn new_unchecked(template_len: usize) -> Self {
        ...
        const COMPRESSED_TEMPLATE_FILES: [&[u8]; 4] = [
            include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/templates/template18.xz")),
            include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/templates/template19.xz")),
            include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/templates/template20.xz")),
            include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/templates/template21.xz")),
        ];
...
/// Split a template file into its individual templates
